...
export const JCD_V3_PROJECT_BASES: JcdV3Project[] = [
  ...
  },
  {
    ...
    playwright: [
      'World Premiere by Morag Shepherd',
    ],
    venue: 'Rose Wagner Performing Arts Center',
    producer: 'Plan-B Theatre Company',
    month: 11,
    ...
    mediaAndPress: [
      {
        ...
        link: {
          ...
          uri: 'https://www.theutahreview.com/plan-b-theatre-sets-world-premiere-in-nov-3-13-run-of-morag-shepherds-my-brother-was-a-vampire/',
        },
      },
      {
        publication: '(QSaltLake Magazine)',
        link: {
          ...
          uri: 'https://www.qsaltlake.com/news/2022/09/24/plan-b-to-premiere-horror-comedy-my-brother-was-a-vampire-by-morag-shepherd/',
        },
      },
      {
        publication: '(Gephardt Daily)',
        link: {
          ...
          uri: 'https://gephardtdaily.com/local/review-plan-bs-my-brother-was-a-vampire-is-bloody-brilliant/',
        },
      },
      {
        publication: '(15 Bytes)',
        link: {
          ...
          uri: 'http://artistsofutah.org/15Bytes/index.php/morag-shepherd-avoids-the-realist-trap-with-a-play-of-sudden-shifts-and-strange-powers/',
        },
      },
    ],
  },
  {
    ...
    productionCredits: [
      ...
      'Conducted by Nicolas Giusti',
      'Technical Direction by Nat Reed',
      'Scenic Design by Peter Dean Beck',
      'Production Scenic & Props Design by Janice Chan',
      'Lighting Design by Peter D. Leonard',
      'Costume, Hair, & Makeup Design by Cee-Cee Swalling',
      'Production Photography by UVU Broadcast Services',
    ],
    mediaAndPress: [
      {
        publication: '(PBS)',
        ...
        link: {
          ...
          uri: 'https://www.pbs.org/video/the-noorda-la-boheme-noaot2/',
        },
      },
    ],
  },
  {
    ...
    productionCredits: [
      ...
      'Scenic & Props Design by Janice Chan',
      'Assistant Scenic & Props Design by Gavin Henry',
      'Lighting Design by Colin Skip Wilson',
  ...
  },
  {
    ...
    playwright: [
      ...
      'Adapted by Cleveland McKay Nicoll',
      'Original Music & Lyrics by McKell Peterson',
    ],
    venue: 'Rock Canyon Trailhead Amphitheater',
    producer: 'Renaissance Now Theatre & Film',
    month: 8,
    year: 2021,
    description: [
    ...
    productionCredits: [
      'Directed by Cleveland McKay Nicoll',
      'Scenic Design by Janice Chan',
      'Scenic Painting by Janice Chan',
      'Lighting Design by Tawnie Robinson',
      'Costume Design by Maryann Hill',
      'Production Photography & Videography by Dave Biesinger',
    ],
    mediaAndPress: [],
  },
  {
    ...
    title: 'Aftershock',
    playwright: [
      'World Premiere by Iris Salazar',
    ],
    venue: 'Rose Wagner Performing Arts Center',
    producer: 'Plan-B Theatre Company',
    month: 4,
    ...
    productionCredits: [
      ...
      'Lighting Design by Emma Eugenia Belnap',
      'Sound Design by Cheryl Ann Cluff',
      'Costume Design by Maddiey Howell',
      'Scenic Construction by Sydney Shoell',
      'Production Photography by Sharah Meservy',
    ],
    mediaAndPress: [
      {
        ...
        link: {
          ...
          uri: 'https://frontrowreviewersutah.com/?p=17185&utm_source=rss&utm_medium=rss&utm_campaign=plan-b-theatres-world-premiere-of-aftershock-shakes-up-salt-lake-city-asking-whats-coming-to-the-surface',
        },
      },
    ],
  },
  {
    ...
    venue: 'Smith Theatre',
    producer: 'The Noorda Center for the Performing Arts & Utah Repertory Theater Company',
    month: 10,
    year: 2019,
    description: [
    ...
    productionCredits: [
      ...
      'Technical Direction & Set Construction by Nat Reed',
      'Set Design by Josh Steadman',
      'Associate Set Design by Janice Chan',
      'Props Design by Rachel Summerhalder',
  ...
  },
  {
    ...
    producer: 'An Other Theater Company',
    month: 7,
    year: 2018,
    description: [
  ...
  },
  {
    ...
    playwright: [
      ...
      'Composed & Arranged by Spicer Carr',
    ],
    venue: 'eXBox Theater',
    producer: 'The Noorda Center for the Performing Arts',
    month: 4,
    ...
    productionCredits: [
      ...
      'Scenic Design by Janice Chan',
      'Props Design by Aimee Findley Moore',
    ...
    mediaAndPress: [
      {
        ...
        link: {
          ...
          uri: 'https://www.uvu.edu/dgm/blog/cinderella.html',
        },
      },
      {
        publication: '(UVU Review)',
        link: {
          ...
          uri: 'https://www.uvureview.com/valley-life/bilingual-theater-for-youth-revives-old-tales-with-new-world-issues/?amp_markup=1',
        },
      },
    ],
  },
  {
    ...
    playwright: [
      'World Premiere by Carleton Bluford',
    ],
    venue: 'Rose Wagner Performing Arts Center',
    producer: 'Plan-B Theatre Company',
    month: 2,
    ...
    mediaAndPress: [
      {
        ...
        link: {
          ...
          uri: 'https://frontrowreviewersutah.com/?p=17052',
        },
      },
      {
        publication: '(The Utah Review)',
        ...
        link: {
          ...
          uri: 'https://www.theutahreview.com/plan-b-theatre-set-to-open-2022-season-in-person-in-color-with-world-premiere-of-carleton-blufords-the-clean-up-project/',
        },
      },
      {
        ...
        link: {
          ...
          uri: 'https://dailyutahchronicle.com/2022/02/17/plan-b-theatre-premiere-the-clean-up-project/',
        },
      },
      {
        publication: '(The Utah Review)',
        link: {
          ...
          uri: 'https://www.theutahreview.com/an-unsurpassed-extraordinary-opening-night-performance-for-the-premiere-of-carleton-blufords-the-clean-up-project-plan-b-theatres-newest-production/',
        },
      },
      {
        publication: '(Salt Lake Magazine)',
        link: {
          ...
          uri: 'https://www.saltlakemagazine.com/review-the-clean-up-project-at-plan-b-theatre/',
        },
      },
      {
        publication: '(15 Bytes)',
        link: {
          ...
          uri: 'http://artistsofutah.org/15Bytes/index.php/carleton-bluford-and-the-process-of-cleaning-up/',
        },
      },
    ],
  },
  ...
  },
  {
    ...
    productionCredits: [
      ...
      'Scenic Design by Janice Chan',
      'Props Design by McKenzie Kiser',
      'Lighting & Projection Design by Aaron Gubler',
    ...
    mediaAndPress: [
      {
        ...
        link: {
          ...
          uri: 'https://frontrowreviewersutah.com/?p=6352',
        },
      },
    ],
  },
